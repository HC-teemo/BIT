...
import static org.grapheco.bit.BITTest.appendToFile;
import static org.grapheco.bit.BITTest.readCSV;
...
//                appendToFile(logfile, acestors.toString());
    ...
    void list() throws Exception {
        TransMethod transMethod = TransMethod.createIndex(IO.loadData("../dataset/generated/size4999999.csv"), 1L);
        String pathname = "../dataset/exp2/h6_10.csv";
