...
//    public long root;
    ...
    public BITwithBytes(long[][] bitmaps, HashMap<String, Long> code2Id, byte[][] codes, HashMap<Long, Integer> id2Index, long[] ids) {
...
//                result[j] = result[j] & bitmap[j];
    ...
    public static BITwithBytes fromCSV(String path) throws Exception {
        ...
        BITwithBytes bit = new BITwithBytes();
...
//        if (!this.idIndex.containsKey(id)) throw new Exception("can not find code of " + id);
    ...
    public static BITwithBytes deserialize(String path) throws Exception {
        Kryo kryo = BITwithBytes.kryo;
        return new BITwithBytes(
