...
//    static byte[][] transpose(byte[][] input, int width) {
//        int len = input.length;
////        byte[][] output = new byte[width][len];
//        BitSet bitSet = new BitSet(len*width);
//        for (int i = 0; i < len; i++) {
//            int finalI = i;
//            BitSet.valueOf(input[i]).stream().forEach(j->bitSet.set(j*len+ finalI));
//        }
//        bitSet.toLongArray()
//
//        return output;
